...
class ProductStatusesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('ProductStatuses') ? [] : ['className' => ProductStatusesTable::class];
        $this->ProductStatuses = TableRegistry::getTableLocator()->get('ProductStatuses', $config);
    }
