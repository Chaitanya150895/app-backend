 ...
 * @method \App\Model\Entity\MenusType|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\MenusType saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
