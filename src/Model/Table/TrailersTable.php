 ...
 * Trailers Model
 *
 * @property &\Cake\ORM\Association\BelongsTo $TrailerStatuses
...
class TrailersTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('TrailerStatuses', [
            'foreignKey' => 'trailer_statuses_id',
            'joinType' => 'INNER'
        ]);
        $this->hasMany('Orders', [
    ...
    {
        $rules->add($rules->existsIn(['trailer_statuses_id'], 'TrailerStatuses'));
